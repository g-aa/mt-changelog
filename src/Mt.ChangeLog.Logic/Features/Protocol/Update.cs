...
public static class Update
{
    ...
    public sealed class Handler : IRequestHandler<Command, MessageModel>
    {
        ...
        public Task<MessageModel> Handle(Command request, CancellationToken cancellationToken)
        {
            ...
            this.logger.LogDebug("Получен запрос на обновление данных протокола '{Model}' в системе.", model);
        ...
        private async Task<MessageModel> SaveChangesAsync(ProtocolEntity entity, CancellationToken cancellationToken)
        {
            ...
            this.logger.LogInformation("Протокол '{Entity}' успешно обновлен в системе.", entity);
