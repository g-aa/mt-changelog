...
namespace Mt.ChangeLog.Logic.Features.Platform
{
    ...
    {
        /// <inheritdoc />
        public sealed class Command : MtCommand<PlatformModel, BaseModel>, IValidatedRequest
        {
            /// <summary>
        ...
        public sealed class Handler : IRequestHandler<Command, BaseModel>
        {
            ...
            private async Task<BaseModel> SaveChangesAsync(Mt.ChangeLog.Entities.Tables.Platform entity, CancellationToken cancellationToken)
            {
