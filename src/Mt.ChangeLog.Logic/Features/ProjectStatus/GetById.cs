...
{
    /// <summary>
    /// Запрос на получение перечня моделий данных для таблиц <see cref="ProjectStatusModel"/>.
    /// </summary>
    public static class GetById
    {
        /// <inheritdoc />
        public sealed class Query : MtQuery<BaseModel, ProjectStatusModel>, IValidatedRequest
        {
            /// <summary>
            ...
            {
                return $"{base.ToString()} - получение сущности вида {nameof(ProjectStatusModel)}.";
            }
        }
