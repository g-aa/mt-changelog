...
| Mt.ChangeLog.DataContext     | Контекст доступа к данным основанный на 'Npgsql.EFCore' для реализации механизма изменяния данных. |
| Mt.ChangeLog.DataAccess      | Уровень доступа к данным основанный на 'Npgsql', 'Dapper' для реализации механизма чтения данных.  |
